...
public class Constant {
    ...
    public static final String DATA_TEST_VI[] = {"./Code Project/Mail datasets/VietNamese/test_SPAM",
        "./Code Project/Mail datasets/VietNamese/test_HAM"};
    public static final String DATA_TEST_VI_2[] = {"./Code Project/Mail datasets/VietNamese/huan/spam",
    "./Code Project/Mail datasets/VietNamese/huan/ham"};
